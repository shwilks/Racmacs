  ...
  if (antigens) {
    for (agnum in seq_along(map$antigens)) {
      ...
      blobgrid <- ac_stress_blob_grid(
        ...
        tabledists = numeric_min_tabledists(tableDistances(map, optimization_number), dilutionStepsize(map))[agnum, ],
  ...
  if (sera) {
    for (srnum in seq_along(map$sera)) {
      ...
      blobgrid <- ac_stress_blob_grid(
        ...
        tabledists = numeric_min_tabledists(tableDistances(map, optimization_number), dilutionStepsize(map))[, srnum],
